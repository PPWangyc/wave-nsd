...
def make_decoder(
    ...
    if architecture == 'autoencoder':
        from decoder.autoencoder import AutoEncoder
        return AutoEncoder(**kwargs)
    
    elif architecture in {'BERT', 'NetBERT'}:
        from decoder.bert import BERTModel
        ...
        from decoder.bert import PretrainedBERT
        return PretrainedBERT(**kwargs)

    elif architecture == 'LinearBaseline':
        from decoder.linear_baseline import LinearBaseline
